 ...
 * Title: Hit Meter 
 * 
 * Description: This class manages the hit meter, which is an object that determines the 
 * effect of an action in battle. It determines the results of attack power, defense power,
 * and whether the player can run away from battle or not.
 * 
 * @author Aalea Ally
 * 
 */ 
