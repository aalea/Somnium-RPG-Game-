 ...
 * Title: Loader 
 * 
 * Description: This class was intended to be a loader for everything in the game, 
 * from the sprites to the music. However, now it only loads the paper messages 
 * from the CSV file and plays the intro music.
 * 
 * @author Aalea Ally
 * 
 */
