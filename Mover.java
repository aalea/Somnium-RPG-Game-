 ...
 * Title: Mover 
 * 
 * Description: This is an abstract template class that extends the JLabel class. 
 * It holds the mover row, column, direction and health points
 * 
 * @author Mr. Fernandes (modified by Aalea Ally to hold health points)
 * 
 */
