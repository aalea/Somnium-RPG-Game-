 ...
 * Title: Protagonist 
 * 
 * Description: This class holds all aspects of the protagonist in the game. It extends
...
public class Protagonist extends Mover {
	...
	public Protagonist() {
		...
		Image image = sprite[0][1].getImage(); //convert imageicon to image
		Image fixedImage = image.getScaledInstance(19, 19, java.awt.Image.SCALE_SMOOTH); //scale image
		sprite[0][1] = new ImageIcon(fixedImage); //convert the scaled image back the imageicon
		...
		sprite[2][0] = new ImageIcon(fixedImage); //convert the scaled image back the imageicon
		
		this.setIcon(sprite[0][1]); //set protagonist to standing right when game starts
